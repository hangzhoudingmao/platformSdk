...
public class SourceListRsp {
    /**
     * total_count : eu
     * total_page : Duis proident
     * list : [{"source_id":"consequat elit ullamco","source_sort_id":"ut voluptate ex venia","source_no":"eiusmod officia Ut i","source_value":"elit dolor","remark":"aliquip"}]
     */
    ...
    public static class ListBean {
        /**
         * source_id : consequat elit ullamco
         * source_sort_id : ut voluptate ex venia
         * source_no : eiusmod officia Ut i
         * source_value : elit dolor
         * remark : aliquip
         */
