...
public class UserAuthRsp {
    ...
    public static class ListBean {
        /**
         * object_id : non ullamco minim
         * object_name : minim
         * object_module : amet
         * object_method : irure
         * object_para : Duis tempor officia
         * object_no : sed eu nulla deserunt
         * object_sort : dolor exercitation
         * order_no : Duis Excepteur esse
         * is_menu : cillum
         * is_priv : velit
         * is_flow : ad tempor sunt incididunt
         * is_samp : amet quis Ut
         */
